...
alias tb="c r -- --noconfirm new --tf=5m --size=0.1 --coin=ADA -p='sar:t5m:s0.07:i0.02:m0.15'"
alias ts="c r -- --noconfirm new --tf=5m --size=-0.1 --coin=ADA -p='sar:t5m:s0.07:i0.02:m0.15'"
